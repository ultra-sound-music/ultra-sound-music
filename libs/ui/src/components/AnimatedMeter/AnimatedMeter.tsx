  ...
  return (
    <div className={styles.AnimatedMeter}>
      ...
      <div className={styles.meter}>
        <Lottie animationData={bar} direction={1} speed={0.5} play={true} segments={[0, value[0]]} loop={false} className={styles.lottie} />
        <Lottie animationData={bar} direction={1} speed={0.5} play={true} segments={[0, value[1]]} loop={false} className={styles.lottie} />
      </div>
    </div>
  );
}
