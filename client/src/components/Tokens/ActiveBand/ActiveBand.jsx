  ...
  render() {
    return (
      <div>
        ...
        {this.props.activeBandName && <div className='User__activeArtist'>Active Band: {this.props.activeBandName} </div>}
      </div>
    )
  }
}
...
export function mapStateToProps(state) {
  ...
  return {
    ...
    canActiveArtistCreateTrackForBand: Selectors.usm.canActiveArtistCreateTrackForBand(state)
  };
}
