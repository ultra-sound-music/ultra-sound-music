...
export default function* web3Saga() {
  ...
  yield takeLatest(
    actionTypes.PROCESS_ACCOUNT_UPDATE,
    Workers.processAccountUpdate
  );
  yield takeLatest(
    actionTypes.PROCESS_NETWORK_UPDATE,
    Workers.processNetworkUpdate
  );
  yield takeLatest(
    actionTypes.UPDATE_NETWORK_STATUS,
    Workers.onUpdateNetworkStatus
  );
}
