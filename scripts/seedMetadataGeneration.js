...
const artists = fs
  .createReadStream('../files/artists.csv')
  .pipe(csv())
...
const bands = fs
  .createReadStream('../files/bands.csv')
  .pipe(csv())
...
const tracks = fs
  .createReadStream('../files/tracks.csv')
  .pipe(csv())
